...
class Brizy_Public_EditorBuild_145Beta3Wp_Texts {
	public static function get_editor_texts() {
		return apply_filters('brizy_editor_config_texts', array(
			...
			"Access your Library in any WP install by connecting your Brizy Cloud account" => __("Access your Library in any WP install by connecting your Brizy Cloud account", "brizy"),
			...
			"Additional Information" => __("Additional Information", "brizy"),
			...
			"Animation link" => __("Animation link", "brizy"),
			...
			"BusinessHour Items" => __("BusinessHour Items", "brizy"),
			"BusinessHour Title" => __("BusinessHour Title", "brizy"),
			"BussinesHour" => __("BussinesHour", "brizy"),
			...
			"Enter the link to Lottie Animation." => __("Enter the link to Lottie Animation.", "brizy"),
			...
			"Offset Top" => __("Offset Top", "brizy"),
			...
			"Purchases" => __("Purchases", "brizy"),
			"Purchases Type" => __("Purchases Type", "brizy"),
			...
			"Saved Library is syncing to your Brizy Cloud account" => __("Saved Library is syncing to your Brizy Cloud account", "brizy"),
			...
			"Separation" => __("Separation", "brizy"),
			...
			"Show Post" => __("Show Post", "brizy"),
			"Show Separation" => __("Show Separation", "brizy"),
			"Show Social Context" => __("Show Social Context", "brizy"),
			"Show Title" => __("Show Title", "brizy"),
			...
			"Thin" => __("Thin", "brizy"),
			"This block is already on the page." => __("This block is already on the page.", "brizy"),
			...
			"WOO Product Meta" => __("WOO Product Meta", "brizy"),
			"WOOCart" => __("WOOCart", "brizy"),
			"WOOPrice" => __("WOOPrice", "brizy"),
			...
			"Woo Add To Cart" => __("Woo Add To Cart", "brizy"),
			"Woo Additional Info" => __("Woo Additional Info", "brizy"),
			"Woo Categories" => __("Woo Categories", "brizy"),
			"Woo Pages" => __("Woo Pages", "brizy"),
			"Woo Price" => __("Woo Price", "brizy"),
			"Woo Product" => __("Woo Product", "brizy"),
			"Woo Product Title" => __("Woo Product Title", "brizy"),
			"Woo Products" => __("Woo Products", "brizy"),
			"Woo SKU" => __("Woo SKU", "brizy"),
			"Woo Stock" => __("Woo Stock", "brizy"),
			...
			"Your Plugin version is incompatible with Cloud version, please update plugin" => __("Your Plugin version is incompatible with Cloud version, please update plugin", "brizy"),

...
export const globalBlocksPositionsSelector = createSelector(
  ...
  (blocksOrder, globalBlocksWithoutPopups) => {
    return getPositions(blocksOrder, globalBlocksWithoutPopups);
  }
);
      ...
      return produce(data, draft => {
        objectTraverse2(draft, obj => {
          if (obj.type && obj.type === "GlobalBlock" && obj.value) {
            ...
            if (globalBlocks[_id]) {
              transformData(Object.assign(obj, globalBlocks[_id].data));
            }
          }
        });
      });
...
// export const pageBlocksComputedAssembledSelector = createSelector(
